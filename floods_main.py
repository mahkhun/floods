...
class FloodsMainInterface(object):
    ...
    def show_form_dialog_ui(self, data_dict):
...
class FloodsFormInterface(qtw.QWidget, Ui_FloodsForm):
    ...
    def accomplished_form(self, data_dict):
...
class FloodsFormDialog(qtw.QDialog, Ui_FloodsFormDialog):
    ...
    def update_descriptions(self, data_dict):
        """ Updates the description displayed in the FloodsFormDialog window. """
        self.date_description_label.setText(data_dict["date"])
        self.region_description_label.setText(data_dict["region"])
        self.location_description_label.setText(data_dict["city/province"])
        self.infrastructure_description_label.setText(data_dict["type of infrastructure"])
        self.damage_description_label.setText(data_dict["extent of damage"])
        self.waterlevel_description_label.setText(data_dict["water level"])
        # - image update here
